#!/usr/bin/env python3
"""build-vps-dylib-89.py — VPS 交叉编译 xnower.dylib（v1.4.89）
复用 vps-build-xnower.py 流程；密码从 .env.local 读；编译全部 .m（除 MinimalTester）。
"""
...
# 6. Download
print("[6] Download...")
local_dir = os.path.join(PROJECT, 'build-artifacts-ci', 'xnower-89')
