...
| 状态 | 问题 | 来源 | 上次更新 |
|------|------|------|---------|
| 待修 | 页面感知浮窗菜单真机验证：13种页面(feed/评论/直播/主页/编辑资料/私信列表/私信对话/朋友/搜索/录制/粉丝列表/设置)菜单是否正确切换 + 截图上报 | 2026-08-11 开发 | 2026-08-15 |
| 待修 | home 误判 live 真机验证：首页 feed 直播预览容器(TTKLivePreview/AWELiveFeedEntrance)误伤旧锚点，已换直播间专属锚点(IESLiveLayout*)需装 v1.4.86 验证 | 2026-08-15 真机 | 2026-08-15 |
| 待修 | 粉丝列表自动关注真机验证：fanlist 菜单"自动关注"循环点右侧Follow→上滑→再点，日志显示左侧用户名，上限200自动停 | 2026-08-15 开发 | 2026-08-15 |
| 待修 | collect_fans 采集粉丝崩溃：v1.4.86 跑13秒崩(系统级kill无堆栈)，根因=列表页滚动no-op空转 + 崩溃捕获路径缺陷。v1.4.87 已修(滚动换_scrollTopListUp+STEP日志+信号路径/backtrace)，装87重测：应能滚动采集到count个且日志有 collect_fans:round=N 步骤 | 2026-08-15 真机 | 2026-08-15 |
| 已修待验 | 设备激活失配：卡7YDYWY绑旧UUID(451D0095)与当前device_id(iphone_0ECF42DC)不符→绑定403未激活。已SQL更新license绑定，设备重启TikTok验证激活恢复 | 2026-08-15 排查 | 2026-08-15 |
