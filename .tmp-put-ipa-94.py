# -*- coding: utf-8 -*-
"""上传 v1.4.94 IPA 到 VPS + 校验 md5 + 确认下载 URL"""
...
IPA = os.path.join(P, 'TikTok_XNOW_v1.4.94_BH.ipa')
REMOTE = '/var/www/ipa/TikTok_XNOW_v1.4.94_BH.ipa'
...
run(f"md5sum {REMOTE}")
ssh.close()
print("URL: http://192.129.210.52/ipa/TikTok_XNOW_v1.4.94_BH.ipa")
